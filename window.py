...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textOverhang = QLineEdit(self.tab_dimensions)
        self.textOverhang.setObjectName(u"textOverhang")
        self.textOverhang.setGeometry(QRect(270, 213, 79, 21))
        self.label_25 = QLabel(self.tab_dimensions)
        self.label_25.setObjectName(u"label_25")
        self.label_25.setGeometry(QRect(270, 190, 79, 17))
        ...
        self.textbox_make = QLineEdit(self.tab_specifications)
        self.textbox_make.setObjectName(u"textbox_make")
        self.textbox_make.setMinimumSize(QSize(250, 0))
        self.textbox_make.setFont(font)

        self.verticalLayout_4.addWidget(self.textbox_make)

        self.label_24 = QLabel(self.tab_specifications)
        ...
        QWidget.setTabOrder(self.y7Back, self.textWidth)
        QWidget.setTabOrder(self.textWidth, self.textbox_year)
        QWidget.setTabOrder(self.textbox_year, self.textbox_number)
        QWidget.setTabOrder(self.textbox_number, self.textbox_make)
        QWidget.setTabOrder(self.textbox_make, self.textbox_model)
        ...
        QWidget.setTabOrder(self.button_create_folders, self.tableWidget)
        QWidget.setTabOrder(self.tableWidget, self.button_add_new_test)
        QWidget.setTabOrder(self.button_add_new_test, self.combo_test_type)
        QWidget.setTabOrder(self.combo_test_type, self.combo_test_name)
        QWidget.setTabOrder(self.combo_test_name, self.tabWidget)
        QWidget.setTabOrder(self.tabWidget, self.x1Front)
        ...
        QWidget.setTabOrder(self.y7Front, self.textOverhang)
        QWidget.setTabOrder(self.textOverhang, self.textLenght)
        QWidget.setTabOrder(self.textLenght, self.x1Side)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.textOverhang.setPlaceholderText(QCoreApplication.translate("MainWindow", u"0.00", None))
        self.label_25.setText(QCoreApplication.translate("MainWindow", u"Overhang:", None))
        ...
        self.label_12.setText(QCoreApplication.translate("MainWindow", u"Make", None))
        self.textbox_make.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Toyota", None))
        self.label_24.setText(QCoreApplication.translate("MainWindow", u"Model", None))
        self.textbox_model.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Yaris", None))
